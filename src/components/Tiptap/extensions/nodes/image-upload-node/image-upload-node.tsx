...
const DropZoneContent: React.FC<{ maxSize: number; limit: number }> = ({
    ...
    <>
        ...
        <div className="tiptap-image-upload-content">
            <span className="tiptap-image-upload-text">
                <em>{TIP_TAP_LOCALE.IMAGE_UPLOAD_NODE.CLICK_TO_UPLOAD}</em> or
                {TIP_TAP_LOCALE.IMAGE_UPLOAD_NODE.OR_DRAG_DROP}
            </span>
            <span className="tiptap-image-upload-subtext">
                {TIP_TAP_LOCALE.IMAGE_UPLOAD_NODE.MAXIMUM_FILES(limit)},{' '}
                {TIP_TAP_LOCALE.IMAGE_UPLOAD_NODE.MAX_SIZE(
                    maxSize / 1024 / 1024
                )}
            </span>
        </div>
