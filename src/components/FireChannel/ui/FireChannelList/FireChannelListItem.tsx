import FireChannelListItemAvatar from '@/components/FireChannel/ui/FireChannelList/FireChannelListItemAvatar';
import FireChannelListItemLastChatContent from '@/components/FireChannel/ui/FireChannelList/FireChannelListItemLastChatContent';
import FireChannelListItemLastChatTime from '@/components/FireChannel/ui/FireChannelList/FireChannelListItemLastChatTime';
import FireChannelListItemTitle from '@/components/FireChannel/ui/FireChannelList/FireChannelListItemTitle';
import { useFireAuth } from '@/components/FireProvider/FireAuthProvider';
import { Badge } from '@/components/ui/badge';
import useFireChannelInfo from '@/components/FireChannel/hook/useFireChannelInfo';
import { FireMessage, FireMessageContent } from '@/components/FireChat/settings';
import { FireChannel } from '@/components/FireChannel/settings';
import { CHANNEL_ID_FIELD } from '@/components/FireChannel/settings';
