import FireChatHeaderAvatar from '@/components/FireChat/ui/FireChatHeader/FireChatHeaderAvatar';
import {
    FireMessage,
    FireMessageContent,
    FIRE_CHAT_LOCALE,
...
import { CHANNEL_NAME_FIELD } from '@/components/FireChannel/settings';
