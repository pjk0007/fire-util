import { useFireChat } from '@/components/FireChat/context/FireChatProvider';
import FireChatRoomFooterTextarea from '@/components/FireChat/ui/FireChatRoom/FireChatRoomFooter/FireChatRoomFooterTextarea';
import FireChatRoomFooterTextareaMobile from '@/components/FireChat/ui/FireChatRoom/FireChatRoomFooter/FireChatRoomFooterTextareaMobile';
import FireChatRoomReplyMessage from '@/components/FireChat/ui/FireChatRoom/FireChatRoomFooter/FireChatRoomReplyMessage';
import FireChatRoomFooterUploadDialog from '@/components/FireChat/ui/FireChatRoom/FireChatRoomFooter/FireChatRoomFooterUploadDialog';
import { useFireAuth } from '@/components/FireProvider/FireAuthProvider';
import { Button } from '@/components/ui/button';
import { Separator } from '@/components/ui/separator';
import { sendTextMessage } from '@/components/FireChat/api/sendMessage';
import useFireChatChannelRoomFooter from '@/components/FireChat/hooks/useFireChatChannelRoomFooter';
import {
    FireMessage,
    FireMessageContent,
    FIRE_CHAT_LOCALE,
...
import FireChatRoomFooterLinkInput from './FireChatRoomFooter/FireChatRoomFooterTools/FireChatRoomFooterLinkInput';
