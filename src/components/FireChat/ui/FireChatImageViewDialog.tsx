...
export default function FireChatImageViewDialog({
    children,
    dialogTitle,
    defaultIdx,
    images,
    ...
    const { openAnnotationDialog } = useFireChat();

    const handleEditClick = () => {
        openAnnotationDialog(images[current]);
        setOpen(false);
    };
            ...
            <DialogContent className="px-0 pt-4 pb-2 gap-2 rounded-sm max-w-[90vw] sm:max-w-[50vw] overflow-hidden">
                ...
                <DialogFooter className="px-4">
                    <Button variant="ghost" onClick={handleEditClick}>
                        <Pencil className="text-foreground/80" />
                    </Button>
                    <DropdownMenu>
