...
import getReplyingMessageContent from '@/components/FireChat/utils/getReplyingMessageContent';
import sanitizeHtml from '@/components/FireChat/utils/sanitizeHtml';
    ...
    return (
        <div
            className={cn(
                ...
                {
                    'bg-muted': !isMine && !isClient,
                    'bg-violet-50': isMine || isClient,
                }
            )}
        >
            {replyingMessage && (
